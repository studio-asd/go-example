...
var file_api_ledger_v1_currency_proto_rawDesc = []byte{
...
var (
	...
	file_api_ledger_v1_currency_proto_rawDescData = file_api_ledger_v1_currency_proto_rawDesc
)

func file_api_ledger_v1_currency_proto_rawDescGZIP() []byte {
	file_api_ledger_v1_currency_proto_rawDescOnce.Do(func() {
		file_api_ledger_v1_currency_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_ledger_v1_currency_proto_rawDescData)
	})
...
func file_api_ledger_v1_currency_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_ledger_v1_currency_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_ledger_v1_currency_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_ledger_v1_currency_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_ledger_v1_currency_proto_rawDesc = nil
