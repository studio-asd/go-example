...
func RegisterLedgerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LedgerServiceServer) error {
	...
	mux.Handle("POST", pattern_LedgerService_Transact_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/go_example.api.ledger.v1.LedgerService/Transact", runtime.WithHTTPPathPattern("/v1/transact"))
		if err != nil {
...
func RegisterLedgerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LedgerServiceClient) error {
	...
	mux.Handle("POST", pattern_LedgerService_Transact_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/go_example.api.ledger.v1.LedgerService/Transact", runtime.WithHTTPPathPattern("/v1/transact"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_LedgerService_Transact_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "transact"}, ""))
)
