...
type GetWalletBalanceRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to FilterParams:
	//
...
func (x *GetWalletBalanceRequest) GetFilterParams() isGetWalletBalanceRequest_FilterParams {
	if x != nil {
...
func (x *GetWalletBalanceRequest) GetWalletId() string {
	if x != nil {
		if x, ok := x.FilterParams.(*GetWalletBalanceRequest_WalletId); ok {
			return x.WalletId
		}
	}
	return ""
...
func (x *GetWalletBalanceRequest) GetUserId() string {
	if x != nil {
		if x, ok := x.FilterParams.(*GetWalletBalanceRequest_UserId); ok {
			return x.UserId
		}
	}
	return ""
